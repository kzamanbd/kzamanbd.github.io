...
// fallback.
//
// It renders the chrome itself: the global not-found boundary lives at the app
// root, outside the `(site)` group, so the navbar and footer that group's layout
// supplies never reach it.
        ...
        <>
            ...
            <main className="relative isolate flex min-h-[70vh] grow flex-col items-center justify-center overflow-hidden px-4 py-28 text-center sm:py-36">
                ...
                <p className="text-foreground/70 mt-4 max-w-xl text-lg leading-relaxed text-balance">
                    The page you are looking for does not exist, moved, or never did. Let&apos;s get
                    you back on track.
                </p>
